...
<div class="sidebar">
	<h3 align="center" > RS Bina Husada</h3>
	<ul><?php
			if ($_SESSION['status']==1) {
				?>
					...
					<li><a id="transaksitambah" href="transaksitambah.php"><i class="fa fa-money"></i>Tambah Barang Masuk</a></li>
					<li><a id="transaksi" href="transaksi.php"><i class="fa fa-money"></i> Tambah Barang Keluar</a></li>
					<li><a id="permintaan" href="permintaan.php"><i class="fa fa-money"></i> Permintaan</a></li>
					<li><a id="users" href="users.php"><i class="fa fa-users"></i> Kasir</a></li>
					<li><a id="laporanmasuk" href="laporanmasuk.php"><i class="fa fa-book"></i> Rekap Barang Masuk</a></li>
					<li><a id="laporan" href="laporan.php"><i class="fa fa-book"></i> Rekap Barang Keluar</a></li>
					<li><a id="laporanminta" href="laporanminta.php"><i class="fa fa-book"></i> Rekap Permintaan Barang</a></li>
