...
function Header()
{
    ...
    $this->Cell(30,10,'Laporan Barang Masuk');
	...
	function data_barang(){
		...
		$data=mysql_query("select sub_transaksi_tambah.no_invoice, 
						sub_transaksi_tambah.jumlah_beli,
						barang.nama_barang,
						barang.harga_jual,
						sub_transaksi_tambah.total_harga,
						transaksi_tambah.tgl_transaksi
						from 
						sub_transaksi_tambah 

						inner join 
						barang on barang.id_barang=sub_transaksi_tambah.id_barang 

						inner join 
						transaksi_tambah on transaksi_tambah.id_transaksi=sub_transaksi_tambah.id_transaksi 

						where 
						sub_transaksi_tambah.no_invoice");
